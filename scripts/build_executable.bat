...
cd %PROJECT_PATH%
%PYINSTALLER_PATH% %MAIN_PATH% --clean --onefile --hidden-import=openpyxl.cell._writer --hidden-import=win32timezone --hidden-import=pyexpat --collect-all xml.parsers.expat
