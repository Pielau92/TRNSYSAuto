...
xcopy "%USERPROFILE%\PycharmProjects\%PROJECT_NAME%\assets\mpc_code\MPCModule.py" "%USERPROFILE%\PycharmProjects\%PROJECT_NAME%\dist\assets\mpc_code\" /y
xcopy "%USERPROFILE%\PycharmProjects\%PROJECT_NAME%\assets\mpc_code\settingsMPC.ini" "%USERPROFILE%\PycharmProjects\%PROJECT_NAME%\dist\assets\mpc_code\" /y
