...
class Building:
    def __init__(self):
        # Variable definition
        self.dt = 3600  # Time interval controller in [s] => 1 h

        # BUILDING A
        # Building specific parameter
        self.Area = 158.46  # Activated Area Building A [m²]
        self.alpha_w = 6.5  # alpha Winter = 6.5 [W/m²K]
        self.alpha_s = 10.75  # alpha Sommer = 10.75 [W/m²K]
        self.k = 120.71  # Factor for convection, transition and ventilation losses [W/K]
        self.cp_TAB = 23.45  # m_TAB*cp_TAB = 23.45 [kWh/K]
        self.cp_R = 54.91  # m_R*cp_R = 54.91 [kWh/K]
